...
We are explaining the vitamin c numerical variable by examining the categorical variable cultivation.We will use the T test to compare the mean of the two vitamin c groups.  
